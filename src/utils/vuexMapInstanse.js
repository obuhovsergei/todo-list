import { resolveComponentNamespace } from "@/utils/vuexModules";

function isPlainObject(obj) {
	return Object.prototype.toString.call(obj) === "[object Object]";
}

export function getModuleState(state, ns) {
 ...
 */
export function mapInstanceState(mappers, getNamespace = resolveComponentNamespace) {
 ...
 * @returns {Object}          instance-aware state computed property methods
 */
export function mapInstanceGetters(mappers, getNamespace = resolveComponentNamespace) {
	if(Array.isArray(mappers)) {
		return mappers.reduce((acc, name) => Object.assign(acc, {
			// Note: Do not use an arrow function as we need to capture `this` at runtime
			[name]() {
 ...
 * @returns {Object}          instance-aware state computed property methods
 */
export function mapInstanceMutations(mutations, getNamespace = resolveComponentNamespace) {
 ...
 * @returns {Object}          instance-aware state computed property methods
 */
export function mapInstanceActions(actions, getNamespace = resolveComponentNamespace) {
